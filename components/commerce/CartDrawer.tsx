        ...
        <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col">
          ...
          <div className="p-6 border-b border-border flex items-center justify-between bg-teal-50/50">
            <h2 className="font-heading font-black text-xl text-teal-900 flex items-center gap-2">
              Your Cart
              {totalItems > 0 && (
                <span className="text-xs bg-teal-700 text-white px-2.5 py-0.5 rounded-full font-bold">
                  {totalItems}
                </span>
              )}
            </h2>
            <button
              onClick={() => setIsCartOpen(false)}
              className="p-2 text-muted hover:text-teal-900 rounded-full hover:bg-teal-100/50 transition-colors"
            ...
            {items.length === 0 ? (
              ...
              items.map((item) => (
                <div
                  ...
                  className="flex gap-4 p-4 rounded-2xl border border-border bg-offwhite/50 hover:bg-white transition-colors"
                >
                  {/* Thumbnail */}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        className="text-muted hover:text-coral-500 p-1 transition-colors"
                        title="Remove item"
                      >
